...
const Section = () => {
    return (
        <>
            ...
            <div className='flex flex-col lg:flex-row max-w-7xl m-auto border-r border-l shadow-xl gap-10 md:gap-5  border-[#E8E1D9] p-4 py-5   '>
                ...
                <motion.div
                    ...
                    className='flex flex-1/2 flex-col gap-5 md:gap-7'>
                ...
                <motion.div
                    ...
                    whileInView={{ opacity: 1, translateX: 0 }}
                    transition={{ duration: 0.8, }}
                    className='flex-1/2 flex flex-col gap-4 w-full max-w-[500px] mx-auto items-start'>
                    <div className='relative w-full h-auto aspect-[4/4] overflow-hidden rounded-2xl'>
                        <Image
                            src='/hero-4.jpg'
                            alt='about image'
                            fill
